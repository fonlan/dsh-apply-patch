/**
 * tsdown build for @fonlan/dsh-apply-patch: the host-half lib (lib/index.js, ESM
 ...
 * with the package-name id `@fonlan/dsh-apply-patch` (the client-modules compose
...
export default [
  ...
  clientBundle('@fonlan/dsh-apply-patch', 'client.js'),
